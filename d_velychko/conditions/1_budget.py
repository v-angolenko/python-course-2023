...
income = float(input("Введіть суму доходів: "))
expenses = float(input("Введіть суму витрат: "))
...
if budget > 0:
    print(f"Ваш бюджет позитивний. Ви у плюсі на: {budget:.2f} грн.")
elif budget < 0:
    
    absolute_budget = abs(budget)
    print(f"Ваш бюджет негативний. Ви у мінусі на: {absolute_budget:.2f} грн.")
else:
