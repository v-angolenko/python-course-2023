...
if user_input in namesList:
    index = namesList.index(user_input)
    print(f"Ім'я {user_input} має індекс {index} у списку namesList")
else:
    print(f"Ім'я {user_input} у списку namesList відсутнє")