...
desired_item = input("Введіть назву товару для перевірки наявності на складі: ")


if desired_item in inventory:
    print(f"Товар {desired_item} є на складі")
else:
    print(f"Товар {desired_item} відсутній на складі")
