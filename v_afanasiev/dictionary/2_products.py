...
stock = {"apples": 20, "bananas": 15}

while True:
    user_input = input("Введіть назву продукту та кількість (+/-): ")
    ...
    try:
        product_name, change = user_input.split()

        if product_name in stock:
            stock[product_name] += int(change)

        else:
            print(f"Продукт {product_name} не знайдено.")
    except ValueError:
        print("Будь ласка використовуйте формат 'назва_продукту +/-кількість'.")
