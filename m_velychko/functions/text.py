...
def analyze_text(text):
    ...
    average_length = length / count if count > 0 else 0

    return count, average_length

user_text = input("Введіть текст для аналізу: ")

result_word_count, result_average_length = analyze_text(user_text)

print(f"Кількість слів у тексті: {result_word_count}")
print(f"Середня довжина слова: {result_average_length}")
