...
income = float(input('Введіть ваші дохід: '))
expenses = float(input('Введіть ваш витрати: '))

budget = income - expenses

if budget > 0:
    print(f'Ваш бюджет позитивний. Ви у плюсі на: {budget} грн.')
elif budget < 0:
    print(f'Ваш бюджет негативний. Ви у мінусі на: {abs(budget)} грн.')
else:
