...
copiedList.reverse()
print('Зворотньо відсортований список :', copiedList)
user_input = input('Введіть число для додавання у зворотньо відсортований список: ' )
if  user_input.isdigit():
    copiedList.append(int(user_input))
    print('Оновлений список: ', copiedList)
else:
